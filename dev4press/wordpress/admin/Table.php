<?php
/**
 * Name:    Dev4Press\v48\Core\Admin\Table
 * Version: v4.8
...
namespace Dev4Press\v48\WordPress\Admin;

use Dev4Press\v48\Core\Helpers\DB;
...
abstract class Table extends WP_List_Table {
	...
	protected function _self( $args, $getback = false, $nonce = null ) : string {
		...
		if ( $getback ) {
			...
			$url .= '&_wp_http_referer=' . urlencode( remove_query_arg( array( '_wpnonce', '_wp_http_referer' ), wp_get_referer() ) );
		}
