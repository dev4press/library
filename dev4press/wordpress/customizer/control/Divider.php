<?php
/**
 * Name:    Dev4Press\v47\WordPress\Customizer\Control\Divider
 * Version: v4.7
...
namespace Dev4Press\v47\WordPress\Customizer\Control;

use Dev4Press\v47\Core\Quick\KSES;
use Dev4Press\v47\WordPress\Customizer\Control;
	...
	protected function render_content() {
		...
		if ( ! empty( $this->description ) ) :
            ...
            <span id="_customize-description-<?php echo esc_attr( $this->id ); ?>"
                    class="description customize-control-description"><?php echo KSES::post( $this->description ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				?></span>
		<?php
		endif;
	}
