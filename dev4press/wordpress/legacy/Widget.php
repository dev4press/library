<?php
/**
 * Name:    Dev4Press\v53\WordPress\Legacy\Widget
 * Version: v5.3
...
namespace Dev4Press\v53\WordPress\Legacy;
...
abstract class Widget extends WP_Widget {
	...
	/** @var \Dev4Press\v53\Core\UI\Widgets */
	...
	protected function shared_update( array $new_instance, array $old_instance ) : array {
		...
		if ( isset( $new_instance['_roles'] ) ) {
			$_roles      = array_map( '\Dev4Press\v53\Core\Quick\Sanitize::text', $new_instance['_roles'] );
