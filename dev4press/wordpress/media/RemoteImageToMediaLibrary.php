...
class RemoteImageToMediaLibrary {
    ...
    private $_test_type = true;
    private $_title_for_name = false;
    private $_mimes = false;
    ...
    private function _attach($file, $post_parent = 0) {
    ...
    public static function instance($url, $data = array(), $args = array()) {
        ...
        if (!$_d4p_image_media) {
            $_d4p_image_media = new RemoteImageToMediaLibrary($url, $data, $args);
        }
