...
/*
Name:    Dev4Press\v41\Core\Options\Process
Version: v4.1
...
use Dev4Press\v41\Core\Quick\Arr;
use Dev4Press\v41\Core\Quick\Sanitize;
use Dev4Press\v41\Core\Quick\Str;
		...
		switch ( $input ) {
			...
			case 'group_multi':
				if ( ! isset( $post[ $key ] ) ) {
					...
					$value = (array) $post[ $key ];
					$value = array_map( '\Dev4Press\v41\Core\Quick\Sanitize::basic', $value );
				}
				break;
			case 'css_size':
