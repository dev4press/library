<?php
/**
 * Name:    Dev4Press\v53\Core\Admin\PostBack
 * Version: v5.3
...
use Dev4Press\v53\Core\Options\Process;
...
abstract class PostBack {
	...
	/** @return \Dev4Press\v53\Core\Admin\Plugin|\Dev4Press\v53\Core\Admin\Menu\Plugin|\Dev4Press\v53\Core\Admin\Submenu\Plugin */
	public function a() {
		return $this->admin;
	}
	...
	public function get_page_name( $name ) : string {
	...
	public function check_capability( $name ) : bool {
