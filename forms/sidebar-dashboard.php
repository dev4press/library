    ...
    if ( panel()->a()->buy_me_a_coffee ) {
        ...
        <div class="d4p-links-group buy-me-a-coffee">
            <a href="https://www.buymeacoffee.com/millan" target="_blank" rel="noopener">
                <img alt="BuyMeACoffee" src="<?php echo esc_url( panel()->a()->url . Library::i()->base_path() . '/resources/gfx/buy_me_a_coffee.png' ); ?>"/>
            </a>
            <a href="https://ko-fi.com/milanpetrovic" target="_blank" rel="noopener">
                <img alt="KoFi" src="<?php echo esc_url( panel()->a()->url . Library::i()->base_path() . '/resources/gfx/ko_fi.png' ); ?>"/>
            </a>
        </div>
