...
if ( ! WPR::is_plugin_active( 'gd-power-search-for-bbpress/gd-power-search-for-bbpress.php' ) && panel()->a()->settings()->get( 'notice_gdpos_hide', 'core' ) === false ) {
    ...
    <div class="d4p-notice-info">
        ...
        <a target="_blank" rel="noopener" href="<?php echo esc_url( $url ); ?>" class="button-primary"><?php _e( "Plugin Home Page", "d4plib" ); ?></a>
        <a href="<?php echo esc_url( $_dismiss_url ); ?>dismiss-power-search" class="button-secondary"><?php _e( "Do not show this notice anymore", "d4plib" ); ?></a>
    </div>
    ...
    <div class="d4p-notice-info">
        ...
        <a target="_blank" rel="noopener" href="<?php echo esc_url( $url ); ?>" class="button-primary"><?php _e( "Plugin Home Page", "d4plib" ); ?></a>
        <a href="<?php echo esc_url( $_dismiss_url ); ?>dismiss-bbpress-toolbox" class="button-secondary"><?php _e( "Do not show this notice anymore", "d4plib" ); ?></a>
    </div>
    ...
    <div class="d4p-notice-info">
        ...
        <a target="_blank" rel="noopener" href="<?php echo esc_url( $url ); ?>" class="button-primary"><?php _e( "Plugin Home Page", "d4plib" ); ?></a>
        <a href="<?php echo esc_url( $_dismiss_url ); ?>dismiss-topic-prefix" class="button-secondary"><?php _e( "Do not show this notice anymore", "d4plib" ); ?></a>
    </div>
    ...
    <div class="d4p-notice-info">
        ...
        <a target="_blank" rel="noopener" href="<?php echo esc_url( $url ); ?>" class="button-primary"><?php _e( "Plugin Home Page", "d4plib" ); ?></a>
        <a href="<?php echo esc_url( $_dismiss_url ); ?>dismiss-forum-notices" class="button-secondary"><?php _e( "Do not show this notice anymore", "d4plib" ); ?></a>
    </div>
    ...
    <div class="d4p-notice-info">
        ...
        <a target="_blank" rel="noopener" href="<?php echo esc_url( $url ); ?>" class="button-primary"><?php _e( "Plugin Home Page", "d4plib" ); ?></a>
        <a href="<?php echo esc_url( $_dismiss_url ); ?>dismiss-topic-polls" class="button-secondary"><?php _e( "Do not show this notice anymore", "d4plib" ); ?></a>
    </div>
    ...
    <div class="d4p-notice-info">
        ...
        <a target="_blank" rel="noopener" href="<?php echo esc_url( $url ); ?>" class="button-primary"><?php _e( "Plugin Home Page", "d4plib" ); ?></a>
        <a href="<?php echo esc_url( $_dismiss_url ); ?>dismiss-quantum-theme" class="button-secondary"><?php _e( "Do not show this notice anymore", "d4plib" ); ?></a>
    </div>
