    ...
    <tbody>
        <tr>
            <td class="cell-singular">
                ...
                <?php d4p_render_select($this->get_list_user_visibility(), array('id' => $this->get_field_id('_users'), 'class' => 'widefat d4plib-div-switch', 'name' => $this->get_field_name('_users'), 'selected' => $instance['_users']), array('data-prefix' => 'visibility')); ?>
            </td>
        </tr>
    </tbody>
</table>
        ...
        <tbody>
            <tr>
                <td class="cell-singular">
                    ...
                    <?php d4p_render_check_radios(d4p_get_wordpress_user_roles(), array('id' => $this->get_field_id('_roles'), 'class' => 'widefat', 'name' => $this->get_field_name('_roles'), 'selected' => $instance['_roles'])); ?>
