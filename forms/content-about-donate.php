...
<div class="d4p-whatsnew-section core-grid">
    <div class="core-row">
        ...
        <div class="core-col-sm-12 core-col-md-6">
            ...
            <p><?php echo esc_html( sprintf( __( "%s has a GitHub repository where you can contribute to development, or submit feature requests and suggestions.", "d4plib" ), panel()->a()->settings()->i()->name() ) ); ?></p>
