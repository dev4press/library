...
<div class="d4p-whatsnew-section core-grid">
    <div class="core-row">
        <div class="core-col-sm-12 core-col-md-6">
            ...
            <p><?php echo sprintf( __( "%s is a free plugin, and if you find it useful or want to support its future development, please consider donating.", "d4plib" ), panel()->a()->settings()->i()->name() ); ?></p>
        ...
        <div class="core-col-sm-12 core-col-md-6">
            ...
            <p><?php echo sprintf( __( "%s has a GitHub repository where you can contribute, or submit feature requests and suggestions.", "d4plib" ), panel()->a()->settings()->i()->name() ); ?></p>
