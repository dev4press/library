        ...
        <div class="core-col-sm-12 core-col-md-6">
            ...
            <p>
                <a href="https://www.buymeacoffee.com/millan" target="_blank" rel="noopener">
                    <img style="max-width: 230px" alt="BuyMeACoffee" src="<?php echo esc_url( panel()->a()->url . Library::i()->base_path() . '/resources/gfx/buy_me_a_coffee.png' ); ?>"/>
                </a>
                <a href="https://ko-fi.com/milanpetrovic" target="_blank" rel="noopener">
                    <img style="max-width: 230px" alt="Ko-Fi" src="<?php echo esc_url( panel()->a()->url . Library::i()->base_path() . '/resources/gfx/ko_fi.png' ); ?>"/>
                </a>
            </p>
        </div>
        <div class="core-col-sm-12 core-col-md-6">
