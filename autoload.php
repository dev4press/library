...
if ( ! function_exists( 'dev4press_core_library_autoloader_47' ) ) {
	function dev4press_core_library_autoloader_47( $class ) {
		$path = DEV4PRESS_V47_PATH;
		$base = 'Dev4Press\\v47\\';
	...
	spl_autoload_register( 'dev4press_core_library_autoloader_47' );
}
