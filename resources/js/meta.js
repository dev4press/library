...
(function($, window, document, undefined) {
    ...
    window.wp.dev4press.v43 = window.wp.dev4press.v43 || {};

    window.wp.dev4press.v43.metabox = {
        library: 'v43',
        init: function() {
            const wrapper = ".d4plib-" + wp.dev4press.v43.metabox.library + "-meta-box-wrapper";
